...
namespace Racheschach.ChessSet.Tests
{
    public class PieceTests
    {
        ...
        public void GetPossibleMovesForBishopTest()
        {
            ...
            //Piece whiteBishopR = b.GetSquareBySquareNotation("h3").Piece;
            ...
            //Piece blackBishopL = b.GetSquareBySquareNotation("a8").Piece;
            //var blackBishopLAssertMoves = new List<Move>() {
            //    b.GetNewMove("a8","a7"),
            //    b.GetNewMove("a8","a6")};
            //Assert.Equal(blackBishopLAssertMoves, blackBishopL.GetPossibleMoves());

            //Piece blackBishopR = b.GetSquareBySquareNotation("f5").Piece;
